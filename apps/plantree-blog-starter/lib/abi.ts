...
export const iSpaceAbi = [
  ...
  {
    type: 'function',
    inputs: [{ name: 'minReturnAmount', internalType: 'uint256', type: 'uint256' }],
    name: 'buy',
    outputs: [
      {
        name: '',
  ...
  {
    type: 'function',
    inputs: [{ name: 'mintPastDuration', internalType: 'uint256', type: 'uint256' }],
    name: 'distributeSubscriptionRewards',
    outputs: [],
    stateMutability: 'nonpayable',
  },
...
export const iSpaceFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'input',
        internalType: 'struct CreateSpaceInput',
        type: 'tuple',
        components: [
  ...
  {
    type: 'function',
    inputs: [{ name: 'spaceAddress', internalType: 'address', type: 'address' }],
    name: 'isSpace',
    outputs: [{ name: '', internalType: 'bool', type: 'bool' }],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    name: 'swap',
    outputs: [{ name: 'returnAmount', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
...
export const spaceAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: 'curation',
    outputs: [{ name: 'curatorCount', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'share',
    outputs: [
      { name: 'daoRevenue', internalType: 'uint256', type: 'uint256' },
      {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'stakingRevenue', internalType: 'uint256', type: 'uint256' },
...
export const spaceFactoryAbi = [
  {
    type: 'constructor',
    inputs: [{ name: 'defaultAdmin', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  { type: 'error', inputs: [], name: 'AccessControlBadConfirmation' },
  {
...
export const tokenAbi = [
  ...
  },
  {
    ...
    name: 'getEthAmountWithoutFee',
    outputs: [{ name: 'ethAmount', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'pure',
  },
  {
    type: 'function',
